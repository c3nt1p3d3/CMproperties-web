...
silent only
cd ~\Documents\CMproperties\ Web\v2
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 index.php
badd +24 stylesheet_v2.css
badd +1 templatemo_style.css
...
silent! normal! zE
let s:l = 212 - ((0 * winheight(0) + 30) / 60)
...
setlocal wrapmargin=10
silent! normal! zE
let s:l = 209 - ((45 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
209
...
setlocal wrapmargin=10
silent! normal! zE
let s:l = 505 - ((57 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
505
normal! 0
tabedit search_result_rent.php
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=10
silent! normal! zE
let s:l = 109 - ((39 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
109
...
setlocal wrapmargin=10
silent! normal! zE
let s:l = 440 - ((1 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
440
