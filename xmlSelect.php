...
<html>
    ...
    <head>
        ...
        <script language="JavaScript">
            // Function that selects and deselects all the references in the Idealista form
    ...
    <body>
        ...
        <form method="post" action="xmlcreateSpainHouses.php" id="form_spainhouses">
            ...
            <div id="main">
                ...
                <div id='column' style='width:200px;float:left;'>
                    ...
                    <?php
                        ...
                        while ($row = mysql_fetch_array($query)){
                            ...
                            if(($counter%19)==0){
                                echo "</div><div id='column' style='width:200;float:left;'>";
                            }
                        }
