...
//            $referencia = $_GET['ref'];
            ...
            $query = mysql_query("SELECT nueva, banco, colab, localidad, MIN(ref), MAX(ref) FROM `Casas` GROUP BY localidad, colab, nueva, banco");
        ...
        <?php
            ...
            $query_all = mysql_query("SELECT nueva, banco, colab, localidad, ref FROM `Casas`");
