<html>
<title>YAENCONTRE XML CREATOR</title>
</html>
...
$publicacion = $xml->createElement("publicacion");
$publicacion = $root->appendChild($publicacion);

$oficina = $xml->createElement("oficina","XXXXX");
$oficina = $kyero->appendChild($oficina);
...
*/
    ...
    $de = $xml->createElement("de",utf8_encode($desc_de));
    $de = $desc->appendChild($de);

    $fr = $xml->createElement("fr",utf8_encode($desc_fr));
...
//fclose($h);
    ...
    $xml->save("XMLexports/kyero/kyero.xml");
    //$xml->save("kyero.xml");
}
