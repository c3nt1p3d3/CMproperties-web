...
<html>
    ...
    <form enctype="multipart/form-data" method="post" action="edit.php">
        ...
        Localidad:<select name="localidad" class="search">
            ...
            <option value="Torre de la Horadada" <?php echo($row['localidad'] == "Torre de la Horadada" ? ' selected="selected"' : null) ?> >Torre de la Horadada</option>
            ...
            <option value="Mar Menor" <?php echo($row['localidad'] == "Mar Menor" ? ' selected="selected"' : null) ?> >Mar Menor</option>
        ...
        Piscina: <input type="checkbox" name="pool" value="1" style="width:1em!important;" <?php echo($row['pool'] == "1" ? ' checked="checked"' : null) ?> ><br><br>
        ...
        Parking: <input type="checkbox" name="parking" value="1" style="width:1em!important;" <?php echo($row['parking'] == "1" ? ' checked="checked"' : null) ?> >
        ...
        Nueva Construccion <input type="checkbox" value="1" name="nueva" style="width:1em!important;" /><br><br>

        Banco <input type="checkbox" value="1" name="banco" style="width:1em!important;" /><br><br>
